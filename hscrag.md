...
### 7.2 核心构建逻辑（`_build_initial_chunks`）
...
### 7.4 自适应配置（`_adaptive_config_for_document`）
...
### 7.5 语义相似度计算（`_semantic_similarity`）
